...
To flash the firmware:
  ...
  - Build the firmware with `make <keyboardname>:<keymapname>`, for example `make ergodox:default`

  - This will result in a hex file called `ergodox_keymapname.hex`, e.g.
    `ergodox_default.hex`
...
To flash with ´teensy-loader-cli´:
  ...
  - Run ´<path/to/>teensy_loader_cli -mmcu=atmega32u4 -w ergodox_<keymap>.hex´
